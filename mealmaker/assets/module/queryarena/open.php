...
<html>
	...
	<body> -->
		...
		<?php $letitallhangout = 0 && $currentuserisadmin; ?>
		<?php $letitallhangout = 1 || $currentuserisadmin; ?>

		<!-- queryarena -->
		<div class="queryarena navbaby<?=( $letitallhangout ? ' open' : '' )?>">

			<?php if( $letitallhangout ): ?>
