	...
	<body>
		...
		<div id="container">
			...
			<?php
				...
				// Set C.R.U.D. operation parameters. 
				$crudopid = 'create';
				$crudtableid = 'mealorders';

				// Handle new C.R.U.D. operation. 
				$queryresult = handleCrudOps($crudopid,$crudtableid);
				$querysuccess = $queryresult['summary']['roweffect'];
				$querysummary = json_encode( $queryresult['summary'] );
				printToPage("querysummary: $querysummary<br>querysuccess: $querysuccess");
				// print "querysummary: $querysummary<br>";
				// print "querysuccess: $querysuccess<br>";
			...
			<section class="item">
				...
				<?php if( $querysuccess ): ?>
					...
					<!-- head -->
					<h2 class="head">Query successful!</h2>
					<!-- /head -->

				<?php else: ?>

					<!-- head -->
					<h2 class="head">Query unsuccessful</h2>
					<!-- /head -->

				<?php endif; ?>

				<!-- returnlink -->
				<a class="returnlink" href="./../?view=<?=$crudtableid?>">Proceed</a>
				<!-- /returnlink -->
