...
// Get slideshow stage. 
const slideshowstage = document.querySelector('div#container section.slideshow div.grid div.stage');
// console.log('Slideshow stage:',slideshowstage);

// Get destination for slide set. 
let slidesetdestination = document.querySelector('div#container section.slideshow div.grid div.stage ul.slideset');
// console.log('Slide set destination:',slidesetdestination);

// Get destination for control dots. 
const controldotsdestination = document.querySelector('div#container section.slideshow div.grid div.controls ul.dotlist');
...
function loadSlideControls() {
	...
	function activateSlideControls() {
		...
		const controldots = document.querySelectorAll('div#container section.slideshow div.grid div.controls ul.dotlist li.dot');
...
function selectSlideByIndex(selectedindex,justStarted) {
	...
	function loadSelectedSlide() {
		...
		function refreshSlideSetDestination() {
			slidesetdestination = document.querySelector('div#container section.slideshow div.grid div.stage ul.slideset');
		}
	}
