...
const courseData = [
	...
	
	{
		...
		content: 'Provides the student with basic theory and practice in person-to-person, small group, and public speaking communication processes. Examines characteristics of communicator behavior with communication in relationships as the basic model; message transmission/reception; effects of communication.',
		postedtime:0,
		numcredits: 3,
		courseprereqs: [],
	},
	...
	},
	{
		...
		content: 'This course presents an introduction to the concepts and techniques of computer programming. Emphasis is placed on developing the student\'s ability to apply problem-solving strategies to design algorithms and to implement these algorithms in the Java Programming language.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'MATH 103',
	...
	},
	{
		...
		content: 'Algorithm and problem-solving methods, design and development of modular programs using the Visual BASIC Language including numeric and string operations, input and output operations, decision constructs, repetitive constructs, array processing, graphics, and sequential and random file processing.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'CS 105',
	...
	},
	{
		...
		content: 'This course presents a study of the administration of a UNIX system. Topics include the UNIX file structure, configuration files in UNIX, daemons, cron/crontab, e-mail, backup and restore, C-shell, Bourne shell, UNIX commands and command-line options, and UNIX system security.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'CS 216',
	...
	},
	{
		...
		content: 'This course presents an introduction to the design and implementation of both traditional and distributed operating systems. Topics include processes, memory management, file systems, I/O, deadlocks, distributed systems, synchronization, distributed file systems, and case studies.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'CS 331',
	...
	},
	{
		...
		content: 'This course provides an introduction to basic models of computational complexity and the representation of infinite objects. Topics that will be examined including grammars, finite state machines, automata theory, Turing machines, computability and decidability, regular and context free languages.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'CS 316',
	...
	
	{
		...
		content: 'Practice in the generation of short essays and in the recognition and elimination of errors in style, usage, and sentence structure. Attention to individual needs.',
		postedtime:0,
		numcredits: 3,
		courseprereqs: [],
	},
	...
	
	{
		...
		content: 'Introduction to sets, axioms, factoring, first and second degree equations and inequalities, graphs, exponents and radicals. Not applicable to General Education requirements and/or minor requirements.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'MATH 081',
	...
	},
	{
		...
		coursenumber:'161',
		title: 'Calculus I',
		content: 'Introduction to limits, continuity, derivatives, and integrals. Applications of derivatives and integrals.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'MATH 140',
	...
	},
	{
		...
		coursenumber:'162',
		title: 'Calculus II',
		content: 'Derivatives and integrals of non-algebraic functions. Techniques of integration. Improper integrals. Further applications of derivatives and integrals. Parametric equations and polar coordinates. Analytic geometry and conic sections. Infinite sequences and series.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'MATH 161',
	...
	},
	{
		...
		content: 'This course examines linear systems, Gaussian elimination, matrix operations, determinants, vector spaces, linear transformations, eigenvalues, eigenvectors, diagonalization, inner product spaces, and applications.',
		postedtime:0,
		numcredits: 4,
		courseprereqs: [
			'MATH 161',
	...
	},
	{
		...
		content: 'Sets, logic and induction, combinations and permutations, graph theory, functions and relations, Boolean algebras and other structures, isomorphisms, homomorphisms, finite state machines.',
		postedtime:0,
		numcredits: 3,
		courseprereqs: [
			'MATH 161',
	...
	},
	{
		...
		content: 'Intended for students who have had one year of calculus. Basic probability theory, applications using combinations, continuous and discrete random variables, estimation, test of hypotheses, correlation and regression, and confidence intervals.',
		postedtime:0,
		numcredits: 3,
		courseprereqs: [
			'MATH 162',
	...
	
	{
		...
		content: 'Report writing for scientists and engineers. Theory and practice of audience analysis, report organization, revision, editing, oral presentations and visual aids.',
		postedtime:0,
		numcredits: 3,
		courseprereqs: [
			'ENGL 111',
...
function addCourseProperties() {
	...
	for(let course of courseData) {
		...
		// Create function for full course title. 
		// course.fulltitle = getFullCourseTitle.bind(course);
	...
	function getCourseTags(course) {
		...
		// Compile components of searchable course tags. 
		let result = [ course.programid, course.coursenumber, course.title, course.content ];
