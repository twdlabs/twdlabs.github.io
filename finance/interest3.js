...
function updateContribution(updateAmount){
	...
	var colFull = "<div class='col-xs-12'>";
	var colHalf = "<div class='col-xs-6'>";
	var colLeft = "<div class='col-xs-4' style='text-align:left;'>";
	var colRight = "<div class='col-xs-8' style='text-align:right;'>";
	var divClose = "</div>";
...
function onSubmit() {
	...
	for( var i=0 ; i<=numPeriods ; i++ ) {
		...
		row = "";
		row += "<div class='row'>";
		row += "<div class='col-xs-2 col-sm-2'>" + "<div>" + rowLabel + "</div>" + "</div>";
		row += "<div class='col-xs-5 col-sm-2'>" + "<div>" + dollar(begin) + "</div>" + "</div>";
		row += "<div class='col-xs-2 col-sm-2 hidden-xs'>" + "<div>" + dollar(earn) + "</div>" + "</div>";
		row += "<div class='col-xs-2 col-sm-2 hidden-xs'>" + "<div>" + dollar(expense) + "</div>" + "</div>";
		row += "<div class='col-xs-2 col-sm-2 hidden-xs'>" + "<div>" + dollar(add) + "</div>" + "</div>";
		row += "<div class='col-xs-5 col-sm-2'>" + "<div>" + dollar(end) + "</div>" + "</div>";
		row += "</div>";
		allRows += row;
	...
	var colFull = "<div class='col-xs-12'>";
	var colHalf = "<div class='col-xs-6'>";
	var colLeft = "<div class='col-xs-7' style='text-align:left;'>";
	var colRight = "<div class='col-xs-5' style='text-align:right;'>";
	var divClose = "</div>";
	var msg = "";
	...
	function newTable() {
		...
		row += "<div class='row'>";
		row += "<div class='col-xs-2 col-sm-2'>" + "<div class='header' id='period'>Period</div>" + "</div>";
		row += "<div class='col-xs-5 col-sm-2'>" + "<div class='header'>Begin Balance</div>" + "</div>";
		row += "<div class='col-xs-2 col-sm-2 hidden-xs'>" + "<div class='header'>Earn</div>" + "</div>";
		row += "<div class='col-xs-2 col-sm-2 hidden-xs'>" + "<div class='header'>Pay</div>" + "</div>";
		row += "<div class='col-xs-2 col-sm-2 hidden-xs'>" + "<div class='header'>Add</div>" + "</div>";
		row += "<div class='col-xs-5 col-sm-2'>" + "<div class='header'>End Balance</div>" + "</div>";
		row += "</div>";
