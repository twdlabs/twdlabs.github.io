...
function loadArchivePage(postlist) {
	...
	function createPreviewPost(post) {
		...
		// Create artist preview post. 
		else if(currentPostType=='artist') {
			// 
			return createArtistPostLayout();
		}
		...
		// Create preview layout for artist post. 
		function createArtistPostLayout() {
			// 
